...
print('<p> The major goal of this project is to compare the gene annotations between two releases for desired specis.')
...
print('<div>')
print('-There are 8 categories of genes (protein coding,pseudogene,ribozyme,ncRNA,tRNA,sRNA,rRNA,antisene),see more in the "Gene Categories" tab')
print('<div>')
print('</section>')
